...
\addsummary[11]{04-modeling}{Feature Modeling}{4}{ % TODO 49 not available anymore
...
\addsummary[10,26]{11-testing}{Product-Line Testing}{11}{
...
\begin{frame}{\myframetitle}
	\begin{fancycolumns}
		...
		\end{note}
		\begin{note}{}
			planned: seminar \deutsch{Proseminar/wiss. Seminar} in the summer term, ``lite'' version of student conf.
		\end{note}
	\nextcolumn
		...
		\end{note}
		\begin{note}{}
			individual project \deutsch{Individualprojekt} also possible
		\end{note}
	\end{fancycolumns}
\end{frame}
