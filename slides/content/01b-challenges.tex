...
\begin{frame}{\myframetitle}
	...
	\end{mycolumns}
\end{frame}
% TODO simplify this slide? rather hard stuff already
...
\begin{frame}{Evolution of the Linux Kernel}
	...
	\mynextcolumn
		...
		\pic[width=\linewidth,trim=100 70 110 80,clip]{linux-stack-plot}
	\end{mycolumns}
	...
	\begin{mycolumns}
		\myexampletight{Number of Products}{
			...
			\begin{itemize}
				...
				\item the current kernel is likely to have roughly $10^{1600}$ products
			\end{itemize}
		}
	\mynextcolumn
