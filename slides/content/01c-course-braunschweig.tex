...
\newcommand{\StudIPLink}{https://studip.tu-braunschweig.de/dispatch.php/course/details?sem_id=94c0c9f23ec833edc0097ec8d037653c&again=yes}
...
\begin{frame}{\myframetitle}
	\begin{fancycolumns}[animation=none]
		...
		\begin{note}{Who Are We?}
			\centering
			\pic[height=40mm,trim={0 35cm 0 0}, clip]{ruben-dunkel}\\[.5ex]
...
%				\item (or oral exam for $\approx 20$ minutes)
			...
			\end{itemize}
		\end{definition}
		\begin{definition}{Study Achievement\deutsch{Studienleistung}} % TODO check
			\begin{itemize}
