...
\begin{frame}{Example: Preference Dialogs}
	\centering\pic[width=0.75\linewidth]{preferences-eclipse}
\end{frame}

\subsection{Configuration Files}

\begin{frame}{Example: Configuration Files}
	\centering\pic[width=0.75\linewidth]{configfile-eclipse-ini} % TODO these are merely CLI options. shall we use an INI file or a file in some standard key-value format?
\end{frame}
...
\begin{frame}{Features as Configuration Options}
	\begin{mycolumns}[columns=3,widths={25,25},animation=none]
		\myexampletight{Directed}{\pic[width=\linewidth,page=3]{graphs}}
		\myexampletight{Colored}{\pic[width=\linewidth,page=11]{graphs}}
	\mynextcolumn
		\myexampletight{Weighted}{\pic[width=\linewidth,page=5]{graphs}}
		\myexampletight{Weighted, Colored}{\pic[width=\linewidth,page=15]{graphs}}
	\mynextcolumn
