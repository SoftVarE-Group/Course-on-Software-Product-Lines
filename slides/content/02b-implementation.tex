...
\end{tiny}	
			\column{.45\textwidth}
				...
				\uncover<2->{\mynote{Discussion}{ 
					\begin{itemize}
						\item {\bf Advantage:} Different instantiations (e.g., colored and uncolored graphs) within the same program.
					\end{itemize}					
					\begin{itemize}
...
\end{tiny}	
			\column{.45\textwidth}
				...
				~
				\uncover<2->{\mynote{}{
					What happens when we change the value of {\tt COLORED} from {\tt false} to {\tt true} (at runtime)?
				}}
