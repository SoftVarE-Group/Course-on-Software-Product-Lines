...
\begin{frame}{Recap: Object-Oriented Key Concepts} % TODO better structure for this slide?
	\begin{mycolumns}
...
\begin{frame}{Recap: Design Patterns\ \mytitlesource{\gof}}
	...
	\mynextcolumn
		\mynotetight{}{\pic[width=\linewidth]{gof}}
	\end{mycolumns}
\end{frame}
...
\begin{frame}[fragile]{Instantiation through Template Method Pattern}
		\begin{columns}
			\column{.45\textwidth}
\begin{tiny}
\begin{codetight}{} % code generell leider sehr klein
public class Graph {
	...
...
\begin{frame}{Feature Combinations?} % zentrieren
	\leftorright{
		\begin{center}
...
\begin{frame}[fragile]{Decorator Pattern as a Solution?} % motivation etwas zu knapp
		\begin{columns}
			\column{.45\textwidth}
\begin{tiny}
\begin{codetight}{}
...
\end{codetight}
\begin{codetight}{} % auf den alten folien war ein bsp dazu, evtl mit reinnehmen
...
\end{codetight} % TODO font too small
\end{tiny}	
\end{frame}
