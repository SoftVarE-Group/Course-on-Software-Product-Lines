...
\begin{frame}[fragile]{Example: Graph Library}
	\begin{mycolumns}[b,columns=3,widths={50,32},height=\textheightwithtitle,animation=none]
		\hfill\pic[height=\textheightwithtitle]{buildsystems-graphs-1} % TODO Graph.java and Edge.java need to be switched in the upper part + what about Node.java and Weight.java?
	\mynextcolumn
\begin{codetight}{}
class Edge {
	Node a, b;
...
\begin{frame}[fragile]{Example: Graph Library}
	\begin{mycolumns}[b,columns=3,widths={50,43},height=\textheightwithtitle,animation=none]
		\hfill\pic[height=\textheightwithtitle]{buildsystems-graphs-2} % TODO requires arrow to edge and graph in the upper part + what about Node.java, Weight.java, EdgeFactory.java?
	\mynextcolumn
\begin{codetight}{}
class Graph {
...
\begin{frame}{Clone-and-Own with Build Systems}
	...
	\end{mycolumns}
\end{frame}
% TODO a general discussion of advantages and disadvantages is missing here
