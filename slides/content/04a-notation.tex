...
\subsection{Feature Models} % syntax

%todo 2 frames, switch image and definitians
\begin{frame}{\myframetitle\ \mytitlesource{\fospl}}\label{frame:fm}
	\begin{mycolumns}
		\myexampletight{}{
			\centering
	...
	\mynextcolumn
		...
		\only<4->{
			\myexample{Valid Configurations}{ % semantics frame
				\begin{itemize}
...
\begin{frame}{\myframetitle}
	...
	\mynextcolumn
		...
		\href{https://featureide.github.io}{\includegraphics[width=\linewidth]{featureide-feature-model-editor}}
	\end{mycolumns}
\end{frame}