...
\begin{frame}{Representations of Variability Models}
	\begin{mycolumns}
		\centering
		\sffamily
		\begin{tikzpicture}
...
\subsection{A ``Universal Formula Language''?}
...
\begin{frame}{Representations of Variability Models}
	\begin{mycolumns}[widths={52,48}]
		...
		\begin{tikzpicture}
			...
			\path [dotted, ->] (cnf) edge[bend left=15] node[sloped,yshift=-2mm,rotate=90] {(ii)} (phi);
...
% 	% can be transformed into a feature model
% 	%feature statistics
% \end{frame}
...
\begin{frame}{\myframetitle}
	...
	%not the same as a cfg map!
\end{frame}

\subsubsection*{Linux Kernel}

\begin{frame}{\myframetitle}
	\vspace{28mm}~\hspace{-15mm}\href{https://dl.acm.org/doi/abs/10.1145/3382025.3414943}{\includegraphics[width=1.2\linewidth,trim=100 510 100 170,clip]{2020/2020-SPLC-Thuem}}
\end{frame}
