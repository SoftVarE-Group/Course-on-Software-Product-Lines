...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[b]
		...
		\myexampletight{Feature Diagram (Graphical Feature Model)}{
			\centering\tiny
		...
		\mynote{Solutions}{
			\begin{enumerate}
				...
				\begin{itemize}
					...
					\item[(b)] Lecture \lecturemodeling\partc{}
				\end{itemize}
...
% TODO move everything related to Linux from this lecture to 05a
