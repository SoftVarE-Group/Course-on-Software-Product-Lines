...
\begin{frame}{\myframetitle}
	...
	\mynextcolumn
		...
		\end{tikzpicture} % TODO why is feature model to configuration map considered semi-automatically? also the term feature diagram has not been introduced before
