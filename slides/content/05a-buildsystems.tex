...
\begin{frame}{\myframetitle\  \mytitlesource{\href{https://dl.acm.org/doi/10.1145/3461002.3473950}{Kuiter~et~al.~2021}}}
	\begin{mycolumns}[columns=2,widths={65}]
		\centering
			\leftandright{
				\myexampletight{\small{\color{blue}Prototype}: LCD, Real-Time Clock}{\pic[width=\linewidth]{pignap-cfg-prototype-lcd-rtc}}
			}{
				\myexampletight{\small{\color{green}Prototype}: OLED Display}{\pic[width=\linewidth]{pignap-cfg-prototype-oled}}
			}
			\parbox{.5\linewidth}{
				\myexampletight{\small{\color{red}Production Device}: OLED, Clock}{\pic[width=\linewidth]{pignap-cfg-production-oled}}
			}
		\mynextcolumn
			\centering
			\pic[width=.63\linewidth,page=1]{pignap-variants-and-features}
			\mynote{}{$\Rightarrow$ one build script per variant}
	\end{mycolumns}
\end{frame}
...
\begin{frame}{\myframetitle\  \mytitlesource{\href{https://dl.acm.org/doi/10.1145/3461002.3473950}{Kuiter~et~al.~2021}}}
	\begin{mycolumns}[widths={60}]
		\mydefinition{How to Implement Features with Build Systems?}{
			\begin{itemize}
				\item step 1: create a feature model
	...
	\mynextcolumn
		\myexampletight{}{
			\centering
			\pic[width=.65\linewidth,page=2]{pignap-variants-and-features}
		}
\end{mycolumns}
\end{frame}
...
\end{kconfigtight}
		\mydefinition{KBuild Language\mysource{\href{https://www.kernel.org/doc/html/latest/kbuild/makefiles.html}{kernel.org}}}{
			\begin{itemize}
