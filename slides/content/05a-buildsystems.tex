...
\end{codetight}
	\end{mycolumns}
\end{frame} % TODO make example consistent with previous examples
...
\begin{frame}{\myframetitle}
	...
	\mynextcolumn
		...
		\end{definition}
	\end{mycolumns}
\end{frame} % TODO almost identical text on both sides
...
\begin{frame}{\myframetitle\  \mytitlesource{\href{https://dl.acm.org/doi/10.1145/3461002.3473950}{Kuiter~et~al.~2021}}}
	\begin{mycolumns}[columns=2,widths={76},animation=none]
		\leftandright{
			\myexample{Case Study: Anesthesia Device}{
				\begin{itemize}
					\item C application
			...
			\uncover<4->{\myexampletight{{\color{red}Production Device}: OLED, Clock}{\centering\pic[height=25mm]{pignap-cfg-production-oled}}}
		}
		\leftandright{
			\uncover<2->{\myexampletight{{\color{green}Prototype}: OLED Display}{\centering\pic[height=25mm]{pignap-cfg-prototype-oled}}}
		}{
			\uncover<3->{\myexampletight{{\color{blue}Prototype}: LCD, Real-Time Clock}{\centering\pic[height=25mm]{pignap-cfg-prototype-lcd-rtc}}}
		}
	\mynextcolumn
