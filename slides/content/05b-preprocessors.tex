...
\begin{frame}{\myframetitle}
	\centering\pic[height=\textheightwithtitle,page=1,trim=20 20 20 40,clip]{preprocessor-wilderness}
\end{frame}
\begin{frame}{\myframetitle}
	\centering\pic[height=\textheightwithtitle,page=2,trim=20 20 20 40,clip]{preprocessor-wilderness}
\end{frame}
\begin{frame}{\myframetitle}
	\centering\pic[height=\textheightwithtitle,page=3,trim=20 20 20 40,clip]{preprocessor-wilderness}
\end{frame}
\begin{frame}{\myframetitle}
	\centering\pic[height=\textheightwithtitle,page=4,trim=20 20 20 40,clip]{preprocessor-wilderness}
\end{frame}
\begin{frame}{\myframetitle}
	\centering\pic[height=\textheightwithtitle,page=5,trim=20 20 20 40,clip]{preprocessor-wilderness}
\end{frame}
% TODO add notes on the examples
