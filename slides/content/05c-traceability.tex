...
\begin{frame}{\myframetitle}
	...
	\mynextcolumn
		...
		\end{definition}
		\begin{note}{}
			\href{https://www.tu-chemnitz.de/informatik/ST/research/material/xenomai/video.wmv}{demo video available} (no sound)
		\end{note}
	\end{mycolumns}
\end{frame}
...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[animation=none,widths={35}]
		...
		\end{definition}
	\mynextcolumn
		\only<1,5-|handout:1>{\fbox{\pic[width=\linewidth]{feature-commander2-cropped}}}%
...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[animation=none,widths={65}]
		\pic[width=\linewidth]{feature-traceability}
	\mynextcolumn
