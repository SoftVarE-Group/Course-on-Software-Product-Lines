...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[animation=none]
		...
		\myexample{Recap: Intuition on Feature Traceability}{find feature \includegraphics[width=.17\linewidth]{pants-blue} in product \includegraphics[width=.17\linewidth]{230}}
		\pause
	...
	\mynextcolumn
		...
		\pause
		\centering\pic[width=.95\linewidth]{messy-lego}
	\end{mycolumns}
\end{frame}
