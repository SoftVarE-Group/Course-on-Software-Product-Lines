...
\begin{frame}[fragile]{\myframetitle}
	\small\begin{mycolumns}[columns=3,T,animation=none,widths={43,32}]
\begin{codetight}{} % TODO: colors not readable on projector
public class Graph {
	List nodes = new ArrayList();
	List edges = new ArrayList();
...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[animation=none]
		...
		\myexample{Recap: Intuition on Feature Traceability}{find feature \includegraphics[width=.15\linewidth]{pants-blue} in product \includegraphics[width=.15\linewidth]{230}}
		\pause
