\begin{frame}{Framework with Plug-Ins}
	\begin{mycolumns}[widths={50,50},animation=none]
		\mydefinition{Framework and Hot Spot TODO:cite}{
		...
		\mydefinition{Plug-In TODO:cite}{
...
\begin{frame}{Simple Java Example: A Family of Dialogs}
	\begin{mycolumns}[widths={50,50},animation=none]
		\myexampletight{}{
...
\begin{frame}{Framework-Based Implementation of Software Product Lines}
	...
	\mynextcolumn		
		...
		\mynote{}{
			\begin{itemize}
				\item Neither glue code nor explicit service composition required (TODO Räder).
				\item But: Full automation comes at a price (s.\ preplanning problem).
			\end{itemize}
		}			
	\end{mycolumns}	
\end{frame}
