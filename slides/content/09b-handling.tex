...
\begin{frame}{S1 (a): Adapt Feature Model - Add Domain Dependency}
	...
	\mynotetight{Consequences}{
		\centering\includegraphics[width=0.9\linewidth,page=1]{interaction-handling}
	}
\end{frame}
...
\begin{frame}[fragile]{Example}
	\begin{mycolumns}[widths={50,50},animation=none]
		...
		\vspace{3mm}
		\mynote{}{
			Same implementation as before, but we make implementation dependency $ShortestPath \pimplies Weighted$ explicit.
		}
	\mynextcolumn
{\small
\begin{codetight}{layer: BasicGraph}
...
\begin{frame}{S1 (b): Adapt Feature Model - Exclude Feature Combinations}
	...
	\centering\includegraphics[width=0.9\linewidth,page=2]{interaction-handling}
\end{frame}
...
\begin{frame}{\myframetitle}
	...
	\mynotetight{Consequences}{
		\centering\includegraphics[width=0.9\linewidth,page=3]{interaction-handling}
	}
\end{frame}
...
\begin{frame}{\myframetitle}
	...
	\mynotetight{Consequences}{
		\centering\includegraphics[width=0.9\linewidth,page=4]{interaction-handling}
	}
\end{frame}
...
\begin{frame}{\myframetitle}
	...
	\mynotetight{Consequences}{
		\centering\includegraphics[width=0.9\linewidth,page=5]{interaction-handling}
	}
\end{frame}
...
\begin{frame}{\myframetitle}
	...
	\mynotetight{Consequences}{
		\centering\includegraphics[width=0.9\linewidth,page=6]{interaction-handling}
	}
\end{frame}
...
\begin{frame}{\myframetitle}
	...
	\mynotetight{Consequences}{
		\centering\includegraphics[width=0.9\linewidth,page=7]{interaction-handling}
	}
\end{frame}
...
%\begin{frame}{\myframetitle}
	\centering\includegraphics[width=\linewidth,page=8,trim=40 30 40 70,clip]{interaction-handling}
%\end{frame}
