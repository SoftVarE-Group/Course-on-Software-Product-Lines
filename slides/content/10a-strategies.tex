	...
	\begin{mycolumns}[t]
		...
		\myexample{Asking Questions About Product Lines}{
			\begin{itemize}
				...
				\item Which products have type errors (and why)? %typechef
				\item Which products violate specifications? %key
				\item Which products have unsafe data flows? %spllift
				\item Which is the fastest product?\\ %performance prediction
					Which product has the smallest executable? %https://ieeexplore.ieee.org/document/9555247
			\end{itemize}
		}
...
\begin{frame}{\myframetitle}
	\begin{mycolumns}
		...
		\mynote{}{
			\begin{itemize}
				\item $\alpha$ \emph{analyzes} the feature (e.g., compiles and verifies (part of) the component)
...
\begin{frame}{\myframetitle}
	\begin{mycolumns}
		...
		\myexample{Today's Examples}{
			\begin{itemize}
				\item analyzing feature mappings
				\item analyzing variable code
			\end{itemize}
		}
	\mynextcolumn
