...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[widths={34,66},animation=none]
		...
		\uncover<2->{\myexample{Feature-Model Formula}{
			\small
	...
	\mynextcolumn
		\uncover<3->{\pic[width=\linewidth]{fop-csur-example}}
	\end{mycolumns}
	\uncover<3->{\mynote{}{Is there dead code? Are there superfluous annotations?}}
\end{frame}
...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[widths={34,66},animation=none]
		...
		\uncover<2->{\mynotetight{Recap: 1:1 Feature Mapping!}{
			\pic[width=\linewidth,clip,trim=0 120 250 0]{feature_komposition1}
		}}
	\mynextcolumn
		\pic[width=\linewidth]{fop-csur-example}
	\end{mycolumns}
	\uncover<3->{\mynote{}{\sout{Is} {\color{red}Are} there \sout{dead code} {\color{red}dead features}? Are there \sout{superfluous annotations} {\color{red}redundant constraints}?}}
\end{frame}
