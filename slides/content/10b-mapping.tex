...
\begin{frame}{\myframetitle}
	\begin{mycolumns}[widths={34,66},animation=none]
		...
		\mynotetight{Recap: 1:1 Feature Mapping!}{
			\pic[width=\linewidth,clip,trim=0 120 250 0]{feature_komposition1}
		}
	\mynextcolumn
		\pic[width=\linewidth]{fop-csur-example}
	\end{mycolumns}
	\uncover<2->{\mynote{}{\sout{Is} {\color{red}Are} there \sout{dead code} {\color{red}dead features}? Are there \sout{superfluous annotations} {\color{red}redundant constraints}?}}
\end{frame}
