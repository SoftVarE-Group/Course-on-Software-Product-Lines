...
\begin{frame}{\myframetitle}
	...
	\mynextcolumn
		\begin{example}{Examples}
			...
			\begin{enumerate}
				\uncover<2->{\item[\color{gray}\textbf{NC}] {\color{gray}all product lines with custom development in application engineering\\(e.g., components and services with glue code, white-box frameworks)}}
