...
\begin{frame}{\myframetitle{}}
	\begin{mycolumns}
		\uncover<1->{
			\begin{definition}{Software Testing \mysource{\sommerville}}\vspace{-1.5ex}
		...
		\uncover<2->{
			\begin{definition}{Validation Testing \mysource{\sommerville}}\vspace{-1.5ex}
				\mycite{Demonstrate to the developer and the customer that the software meets its requirements.}
			\end{definition}
		}
		\uncover<3->{
			\begin{definition}{Defect Testing \mysource{\sommerville}}\vspace{-1.5ex}
	...
	\mynextcolumn
		...
		\uncover<5->{
			\begin{note}{Manual vs Automated Testing \mysource{\sommerville}}\vspace{-1.5ex}
