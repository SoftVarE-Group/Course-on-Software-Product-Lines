...
\begin{frame}{\insertsubsection}
	\begin{mycolumns}
		...
		~\hfill\includegraphics[width=.2\linewidth]{pants-blue}\hfill\includegraphics[width=.2\linewidth]{pants-red}\hfill~
	\mynextcolumn
		\todots
...
\begin{frame}{\insertsubsection}
	\begin{mycolumns}[widths={40}]
		...
		find feature \includegraphics[width=.17\linewidth]{pants-blue} in source code \includegraphics[width=.17\linewidth]{230}
	\mynextcolumn
...
\begin{frame}{\insertsubsection}
	\begin{mycolumns}[widths={45},animation=none]
		\myexample{Product Line with Features}{
			\only<1-2>{\includegraphics[width=\linewidth]{metaproduct}}%
