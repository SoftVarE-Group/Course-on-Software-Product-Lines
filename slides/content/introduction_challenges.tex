...
\begin{frame}{Evolution of the Linux Kernel}
	\leftorright{
		\myexampletight{Size of the Code Base}{\includegraphics[width=\linewidth,page=1]{linux-plots}}
	}{
		\myexampletight{Number of Features}{\includegraphics[width=\linewidth,page=2]{linux-plots}}
	}
\end{frame}

\begin{frame}{Evolution of the Linux Kernel}
	\leftorright{
		\myexampletight{Number of Products}{\includegraphics[width=\linewidth,page=3]{linux-plots}}
	}{
		\myexampletight{Time to Count Products}{\includegraphics[width=\linewidth,page=4]{linux-plots}}
	}
\end{frame}
