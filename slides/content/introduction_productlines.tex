...
\begin{frame}{Recap: The Software Life Cycle}
	\waterfallcartoon\\
\end{frame}
...
\begin{frame}{What is a Feature?}
	\leftandright{
		...
		\centering\xkcd{2369}{width=.8\linewidth}
	}{
...
\end{frame}
% TODO 		\todo{picture of a program highlighting one or two features? settings? changelog? marketing description of new features (Github?)?}
