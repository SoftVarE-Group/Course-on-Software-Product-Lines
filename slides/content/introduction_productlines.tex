...
\begin{frame}{What do these examples have in common?}
	\begin{mycolumns}[columns=3,widths={35,28},animation=none]
		\href{https://de.wikipedia.org/wiki/Datei:White_and_red_wedding_dress.jpg}{\includegraphics[width=\linewidth,trim=25 200 25 25,clip]{wedding}}
		
		\href{https://st.museum-digital.de/singleimage?noiiif=1&&imagenr=55758}{\includegraphics[width=\linewidth]{shoes}}
	\mynextcolumn
		\href{https://commons.wikimedia.org/wiki/File:Tour_Eiffel_Wikimedia_Commons_(cropped).jpg}{\includegraphics[width=\linewidth,trim=85 0 0 0]{eiffel-tower}}
	\mynextcolumn
		\href{https://en.wikipedia.org/wiki/File:Draisine_or_Laufmaschine,_around_1820._Archetype_of_the_Bicycle._Pic_01.jpg}{\includegraphics[width=\linewidth,trim=70 35 0 0]{draisine}}
...
\begin{frame}{\insertsubsection}
	\begin{mycolumns}
		...
		\centering\href{https://commons.wikimedia.org/wiki/File:Wollmilchsau.png}{\includegraphics[width=.5\linewidth]{wollmilchsau}}
	\mynextcolumn
		\vspace{-8mm}
		\href{https://en.wikipedia.org/wiki/File:Wenger_EvoGrip_S17.JPG}{\includegraphics[width=\linewidth]{swiss-army-knife}}
...
\begin{frame}{About Every Second Car is Unique}
	\centering\href{https://en.wikipedia.org/wiki/File:I-80_Eastshore_Fwy.jpg}{\includegraphics[width=.66\linewidth]{many-cars}}
\end{frame}
\begin{frame}{\insertsubsection\ \deutschertitel{Kundenindividuelle Massenproduktion}}
	...
	\mynextcolumn
		\myexampletight{Car Production}{\href{https://commons.wikimedia.org/wiki/File:Geely_assembly_line_in_Beilun,_Ningbo.JPG}{\includegraphics[width=\linewidth,trim=0 50 0 240,clip]{car-manufacturing}}}
...
\begin{frame}{What is a Product?}
	...
	\mynextcolumn
		\myexampletight{Product Map for Eclipse}{
			\href{https://www.eclipse.org/downloads/packages/compare}{\includegraphics[width=\linewidth,trim=0 0 675 0]{eclipse-product-map}}
		}
	\end{mycolumns}
\end{frame}
...
\begin{frame}{What is a Domain?}
	...
	\mynextcolumn
		\href{https://en.wikipedia.org/wiki/File:I-80_Eastshore_Fwy.jpg}{\includegraphics[width=.5\linewidth]{many-cars}}

		\hfill\xkcd{2369}{width=.5\linewidth,trim=35 35 35 35,clip}\hfill{}

		\hfill\href{https://de.wikipedia.org/wiki/Datei:Eclipse-Luna-Logo.svg}{\includegraphics[width=.5\linewidth]{eclipse-luna}}
	\end{mycolumns}
\end{frame}
