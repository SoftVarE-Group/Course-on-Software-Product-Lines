...
\begin{frame}{\insertsubsection}
	\leftorright{
		...
		\mynote{Mass Production for Software? \mysource{\fospl}}{\mycite{The idea is to provide software that satisfies the
...
\begin{frame}{What is a Feature?}
	\leftorright{
		...
		\mynote{Feature in a Product Line \mysource{\fospl}}{\mycitebegin Features are used in \todo{product-line engineering}
			\begin{itemize}
...
\subsection{Product-Line Engineering} % TODO together with mass customization?
\begin{frame}{\insertsubsection}
	\leftorright{
		\todots
	}{
...
% goal of PLE: invest one-time effort, reduce effort per product
% tailor-made, reduced costs, improved quality \mysource{\fospl}
