...
\lessonslearned{
	...
	\begin{itemize}
		% TODO given a configuration map with 7 configurations, draw a corresponding feature model
...
} % TODO these are three tasks and probably too much for this lecture. we could choose one of those and leave the rest for the exercise.
