...
\ifuniversity{recording}{\date{???}\setpicture[350]{may21-west2}}
...
\ifuniversity{recording}{\date{???}\setpicture[70]{ovgu-winter4}\setcopyright{Photo: Jana Dünnhaupt (OVGU)}}
...
\ifuniversity{recording}{\date{???}} % TODO \setpicture[200]{}
\ifuniversity{ulm}{\date{July 6, 2023}} % TODO \setpicture[200]{}
