...
\newcommand{\featureDiagramConfigurableDatabase}{
	\featureDiagram{
		\subnode{ConfigDB}{ConfigDB},concrete
		[\subnode{API}{API},abstract,mandatory
			[\subnode{Get}{Get},concrete,or]
			[\subnode{Put}{Put},concrete]
			[\subnode{Delete}{Delete},concrete]
		]
		[\subnode{Transactions}{Transactions},concrete,optional]
		[\subnode{OS}{OS},abstract,mandatory
			[\subnode{Windows}{Windows},concrete,alternative]
			[\subnode{Linux}{Linux},concrete]
		]
	}\\
...
\newcommand{\emphfeature}[1]{\node [draw=black,line width=0.8pt,fit=(#1)] {};}
\newcommand{\emphfeatures}[1]{
	\begin{tikzpicture}[overlay,remember picture]
		\foreach \f in {#1} {\emphfeature{\f}}
	\end{tikzpicture}
}