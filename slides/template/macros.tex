...
\ifdarkmode
	\renewcommand{\emph}[1]{{\color{orange}#1}} % workaround for better readability
\fi

\newcommand{\deutsch}[1]{{\color{blue}(#1)}}
\ifdarkmode
	\renewcommand{\deutsch}[1]{{\color{orange}(#1)}}
\fi
...
\newcommand{\faq}[3]{
	...
	\begin{frame}{\emph{FAQ} -- \insertsubtitle{}}
		\small
		\begin{mycolumns}[t,columns=3,widths={33,33,33},animation=none]
