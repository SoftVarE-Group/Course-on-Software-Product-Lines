...
% emphasizing links
\hypersetup{linkcolor=uulm@text, citecolor=red, filecolor=red, runcolor=red, urlcolor=red, colorlinks=true}
...
\ifdarkmode
	\renewcommand{\picDark}[2][]{\pic[#1,decodearray={1 .25 1 .25 1 .25 1 .25}]{#2}}
\fi
