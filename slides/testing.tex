...
\begin{frame}{Black-Box Testing \mytitlesource{\ludewiglichter}}
	\leftorright{
		\mynote{Motivation}{
			\begin{itemize}
				\setlength\itemsep{.1em}
		...
		\mydefinition{1. Equivalence Class Testing}{
			\begin{itemize}
				\setlength\itemsep{.1em}
		...
		\vspace{-1mm}
		\mydefinition{2. Boundary Testing}{
			\begin{itemize}
			\setlength\itemsep{.1em}
