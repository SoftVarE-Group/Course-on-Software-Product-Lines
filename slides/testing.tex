...
\begin{frame}{\insertsubsection}
	\leftorright{
		...
		\mynote{Product-Line Complexity Classes}{
			\begin{enumerate}
				\item Can we compute the number of valid configurations?
				\item Can we generate the list of valid configurations?
				\item Can we generate and compile all products?
				\item Can we test all products?
				\item Can we manually list all valid configurations?
			\end{enumerate}
		}
...
\begin{frame}{\insertsubsection}
	\leftorright{
		...
		\myexampletight{Effectivity of Interaction Testing \mysource{\href{https://ieeexplore.ieee.org/document/1321063}{Kuhn et al.\ 2004}}}{
			\centering\includegraphics[width=.9\linewidth,page=1]{citplots}
		}
...
\begin{frame}{\insertsubsection\ \mytitlesource{\icpl}}
	\leftorright{
		\myexampletight{Time in Minutes to Compute Sample}{
			\centering\includegraphics[width=.8\linewidth,page=2]{citplots}
		}
		\myexample{}{
			\begin{itemize}
				\setlength\itemsep{.5em}
		...
		\myexampletight{Number of Configurations in Sample}{
			\centering\includegraphics[width=.8\linewidth,page=3]{citplots}
		}
		\myexample{}{
			\begin{itemize}
				\setlength\itemsep{.5em}
...
\begin{frame}{\insertsubsection\ \mytitlesource{\icpl}}
	\leftorright{
		\myexampletight{Assumption: All Features are Optional}{
			\centering\scriptsize\featureDiagramEightOptionalFeatures
		}
		
		\myexampletight{Number of Configurations in Pairwise Sample}{
			\centering\includegraphics[width=.9\linewidth,page=4]{citplots}
		}
	}{%
		\myexampletight{Assumption: All Features are Optional}{
			\centering\scriptsize\featureDiagramEightOptionalFeatures
		...
		\myexampletight{Number of Configurations in T-Wise Sample}{
			\centering\includegraphics[width=.9\linewidth,page=5]{citplots}
		}
	}
\end{frame}
